...
const HeroSection = () => {
  ...
  return (
    ...
    >
   <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x mt-24 md:mt-0 mx-auto">
    <p className='text-xl font-medium text-[#FF1791]'>Azhar shaikh presents</p>
    <h1 className='mt-2 py-2.5 text-4xl xl:text-8xl font-palanquin sm:max-sm:text-[72px] sm:max-sm:leading-[82] font-bold leading-none'>
